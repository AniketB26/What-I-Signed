export default function Skeleton({ className = '', variant = 'text' }) {
  const base =
    'bg-gradient-to-r from-white/35 via-white/70 to-white/35 bg-[length:200%_100%] animate-shimmer rounded-lg';
  ...
  return (
    <div className="space-y-4">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="glass-tile p-5 flex items-center gap-4">
